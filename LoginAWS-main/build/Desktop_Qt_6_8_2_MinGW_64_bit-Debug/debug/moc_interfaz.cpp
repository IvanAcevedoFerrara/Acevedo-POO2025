...
static constexpr auto qt_meta_stringdata_ZN8InterfazE = QtMocHelpers::stringData(
    "Interfaz",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8InterfazE[] = {
...
Q_CONSTINIT const QMetaObject Interfaz::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8InterfazE.offsetsAndSizes,
    qt_meta_data_ZN8InterfazE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8InterfazE_t,
        // Q_OBJECT / Q_GADGET
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_exportTxtButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_exportWordButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Interfaz::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->audioGrabado((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *Interfaz::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8InterfazE.stringdata0))
