...
static constexpr auto qt_meta_stringdata_ZN9RegistrarE = QtMocHelpers::stringData(
    "Registrar",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9RegistrarE[] = {
...
Q_CONSTINIT const QMetaObject Registrar::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9RegistrarE.offsetsAndSizes,
    qt_meta_data_ZN9RegistrarE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9RegistrarE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Registrar, std::true_type>,
...
void Registrar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onRegisterReply(); break;
        default: ;
        }
    }
    (void)_a;
...
void *Registrar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9RegistrarE.stringdata0))
