...
Login::Login(){
    ...
    connect( pbIngresar, SIGNAL(pressed()), this, SLOT(slot_validadUsuario()));
    connect( leClave, SIGNAL(returnPressed()), this, SLOT(slot_validadUsuario()));
}

void Login::slot_validadUsuario()
{
